...
func (d *dbBaseOpengauss) GenerateOperatorLeftCol(fi *models.FieldInfo, operator string, leftCol *string) {
	switch operator {
...
func (d *dbBaseOpengauss) HasReturningID(mi *models.ModelInfo, query *string) bool {
...
// sync auto key
func (d *dbBaseOpengauss) setval(ctx context.Context, db dbQuerier, mi *models.ModelInfo, autoFields []string) error {
	if len(autoFields) == 0 {
		return nil
	}
...
func (d *dbBaseOpengauss) IndexExists(ctx context.Context, db dbQuerier, table string, name string) bool {
