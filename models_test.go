...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/libra9z/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/libra9z/orm.GroupPermissions)"`
}
...
var helpinfo = `need driver and source!
	...
	go Get -u github.com/libra9z/orm
	...
	go test -v github.com/libra9z/orm
