...
func (d *dbBaseDm) GetColumns(ctx context.Context, db dbQuerier, table string) (map[string][3]string, error) {
...
func (d *dbBaseDm) Insert(ctx context.Context, q dbQuerier, mi *models.ModelInfo, ind reflect.Value, tz *time.Location) (int64, error) {
...
func (d *dbBaseDm) InsertValue(ctx context.Context, q dbQuerier, mi *models.ModelInfo, isMulti bool, names []string, values []interface{}) (int64, error) {
	Q := d.ins.TableQuote()
	var vu []interface{}
